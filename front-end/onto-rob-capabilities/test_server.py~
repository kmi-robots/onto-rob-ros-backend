from flask import Flask, request, make_response, request, current_app
...
@crossdomain(origin='*')
def capability():
    with open("/Users/emanuelebastianeli/Work/KMi/Research/Robotics/RobotCapability/capabilities_temp.json","r") as f:
        lines = f.readlines()
        return lines[0]
